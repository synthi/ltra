// lib/Engine_Ltra.sc | v1.1.1
// LTRA Audio Engine - HYBRID MASTER
// Logic: Multiplicative VCA (Latch required for Drone) + External Audio Return (Loopers to Delay)
    ...
    alloc {
        ...
        SynthDef(\ltra_core, {
            arg out, looper_bus,
                ...
                loop_return_level=1.0, // Nivel de entrada de Softcut al Delay
                pre_post_switch=0;
            ...
            var sc_return; // Audio externo (Loopers)
            ...
            // VCA MULTIPLICATIVO (Requiere Latch/Gate para sonar)
            ...
            // --- 7. SPACE (Con Retorno de Loopers) ---
