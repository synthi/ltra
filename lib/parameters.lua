...
function Params.init(g_ref)
    local Globals = g_ref
    params:add_separator("LTRA v3.0.0")
    ...
    params:add_option("arp_div", "Clock Div", sync_opts, 16) 
    ...
    for i=1, 4 do
        ...
        params:add_option("mod"..i.."_lfo_div", "MOD"..i.." LFO Div", sync_opts, 16)
        ...
        params:add_option("mod"..i.."_chaos_div", "MOD"..i.." Chaos Div", sync_opts, 16)
